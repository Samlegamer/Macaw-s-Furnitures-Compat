...
public class McwFurnituresBYG
{
	...
	public McwFurnituresBYG()
	{
		...
		log.info("Macaw's Furnitures - Oh the Biomes We've Gone : Loading...");
		IEventBus bus = FMLJavaModLoadingContext.get().getModEventBus();
		MFurniBYGBlocksRegistry.ITEMS_REGISTRY.register(bus);
		MFurniBYGBlocksRegistry.BLOCKS_REGISTRY.register(bus);
		MFurniBYGBlocksRegistry.Item_Group.register(bus);
		log.info("Macaw's Furnitures - Oh the Biomes We've Gone : Is Charged");
	}
	...
	{	
		...
		ItemBlockRenderTypes.setRenderLayer((Block)MFurniBYGBlocksRegistry.ironwood_glass_table.get(), RenderType.translucent());
		ItemBlockRenderTypes.setRenderLayer((Block)MFurniBYGBlocksRegistry.stripped_ironwood_glass_table.get(), RenderType.translucent());
		...
		ItemBlockRenderTypes.setRenderLayer((Block)MFurniBYGBlocksRegistry.sakura_glass_table.get(), RenderType.translucent());
		ItemBlockRenderTypes.setRenderLayer((Block)MFurniBYGBlocksRegistry.stripped_sakura_glass_table.get(), RenderType.translucent());
		...
		ItemBlockRenderTypes.setRenderLayer((Block)MFurniBYGBlocksRegistry.florus_glass_table.get(), RenderType.translucent());
		ItemBlockRenderTypes.setRenderLayer((Block)MFurniBYGBlocksRegistry.stripped_florus_glass_table.get(), RenderType.translucent());
	}
	    
    private void AddTab(BuildCreativeModeTabContentsEvent event)
    {
    	 if (event.getTab() == MFurniBYGBlocksRegistry.MFURNI_BYG.get())
    	 {
    		 ...
    		 event.accept(MFurniBYGBlocksRegistry.ironwood_wardrobe.get());
    		 event.accept(MFurniBYGBlocksRegistry.ironwood_modern_wardrobe.get());
    		 event.accept(MFurniBYGBlocksRegistry.ironwood_double_wardrobe.get());
    		 event.accept(MFurniBYGBlocksRegistry.ironwood_bookshelf.get());
    		 event.accept(MFurniBYGBlocksRegistry.ironwood_bookshelf_cupboard.get());
    		 event.accept(MFurniBYGBlocksRegistry.ironwood_drawer.get());
    		 event.accept(MFurniBYGBlocksRegistry.ironwood_double_drawer.get());
    		 event.accept(MFurniBYGBlocksRegistry.ironwood_bookshelf_drawer.get());
    		 event.accept(MFurniBYGBlocksRegistry.ironwood_lower_bookshelf_drawer.get());
    		 event.accept(MFurniBYGBlocksRegistry.ironwood_large_drawer.get());
    		 event.accept(MFurniBYGBlocksRegistry.ironwood_lower_triple_drawer.get());
    		 event.accept(MFurniBYGBlocksRegistry.ironwood_triple_drawer.get());
    		 event.accept(MFurniBYGBlocksRegistry.ironwood_covered_desk.get());
    		 event.accept(MFurniBYGBlocksRegistry.ironwood_modern_desk.get());
    		 event.accept(MFurniBYGBlocksRegistry.ironwood_table.get());
    		 event.accept(MFurniBYGBlocksRegistry.ironwood_end_table.get());
    		 event.accept(MFurniBYGBlocksRegistry.ironwood_coffee_table.get());
    		 event.accept(MFurniBYGBlocksRegistry.ironwood_glass_table.get());
    		 event.accept(MFurniBYGBlocksRegistry.ironwood_chair.get());
    		 event.accept(MFurniBYGBlocksRegistry.ironwood_modern_chair.get());
    		 event.accept(MFurniBYGBlocksRegistry.ironwood_striped_chair.get());
    		 event.accept(MFurniBYGBlocksRegistry.ironwood_stool_chair.get());
    		 event.accept(MFurniBYGBlocksRegistry.ironwood_counter.get());
    		 event.accept(MFurniBYGBlocksRegistry.ironwood_drawer_counter.get());
    		 event.accept(MFurniBYGBlocksRegistry.ironwood_double_drawer_counter.get());
    		 event.accept(MFurniBYGBlocksRegistry.ironwood_cupboard_counter.get());
    		 event.accept(MFurniBYGBlocksRegistry.stripped_ironwood_wardrobe.get());
    		 event.accept(MFurniBYGBlocksRegistry.stripped_ironwood_modern_wardrobe.get());
    		 event.accept(MFurniBYGBlocksRegistry.stripped_ironwood_double_wardrobe.get());
    		 event.accept(MFurniBYGBlocksRegistry.stripped_ironwood_bookshelf.get());
    		 event.accept(MFurniBYGBlocksRegistry.stripped_ironwood_bookshelf_cupboard.get());
    		 event.accept(MFurniBYGBlocksRegistry.stripped_ironwood_drawer.get());
    		 event.accept(MFurniBYGBlocksRegistry.stripped_ironwood_double_drawer.get());
    		 event.accept(MFurniBYGBlocksRegistry.stripped_ironwood_bookshelf_drawer.get());
    		 event.accept(MFurniBYGBlocksRegistry.stripped_ironwood_lower_bookshelf_drawer.get());
    		 event.accept(MFurniBYGBlocksRegistry.stripped_ironwood_large_drawer.get());
    		 event.accept(MFurniBYGBlocksRegistry.stripped_ironwood_lower_triple_drawer.get());
    		 event.accept(MFurniBYGBlocksRegistry.stripped_ironwood_triple_drawer.get());
    		 event.accept(MFurniBYGBlocksRegistry.stripped_ironwood_desk.get());
    		 event.accept(MFurniBYGBlocksRegistry.stripped_ironwood_covered_desk.get());
    		 event.accept(MFurniBYGBlocksRegistry.stripped_ironwood_modern_desk.get());
    		 event.accept(MFurniBYGBlocksRegistry.stripped_ironwood_table.get());
    		 event.accept(MFurniBYGBlocksRegistry.stripped_ironwood_end_table.get());
    		 event.accept(MFurniBYGBlocksRegistry.stripped_ironwood_coffee_table.get());
    		 event.accept(MFurniBYGBlocksRegistry.stripped_ironwood_glass_table.get());
    		 event.accept(MFurniBYGBlocksRegistry.stripped_ironwood_modern_chair.get());
    		 event.accept(MFurniBYGBlocksRegistry.stripped_ironwood_striped_chair.get());
    		 event.accept(MFurniBYGBlocksRegistry.stripped_ironwood_stool_chair.get());
    		 event.accept(MFurniBYGBlocksRegistry.stripped_ironwood_counter.get());
    		 event.accept(MFurniBYGBlocksRegistry.stripped_ironwood_drawer_counter.get());
    		 event.accept(MFurniBYGBlocksRegistry.stripped_ironwood_double_drawer_counter.get());
    		 event.accept(MFurniBYGBlocksRegistry.stripped_ironwood_cupboard_counter.get());
    		 event.accept(MFurniBYGBlocksRegistry.ironwood_kitchen_cabinet.get());
    		 event.accept(MFurniBYGBlocksRegistry.ironwood_double_kitchen_cabinet.get());
    		 event.accept(MFurniBYGBlocksRegistry.ironwood_glass_kitchen_cabinet.get());
    		 event.accept(MFurniBYGBlocksRegistry.stripped_ironwood_kitchen_cabinet.get());
    		 event.accept(MFurniBYGBlocksRegistry.stripped_ironwood_double_kitchen_cabinet.get());
    		 event.accept(MFurniBYGBlocksRegistry.stripped_ironwood_glass_kitchen_cabinet.get());
    		 ...
    		 event.accept(MFurniBYGBlocksRegistry.sakura_wardrobe.get());
    		 event.accept(MFurniBYGBlocksRegistry.sakura_modern_wardrobe.get());
    		 event.accept(MFurniBYGBlocksRegistry.sakura_double_wardrobe.get());
    		 event.accept(MFurniBYGBlocksRegistry.sakura_bookshelf.get());
    		 event.accept(MFurniBYGBlocksRegistry.sakura_bookshelf_cupboard.get());
    		 event.accept(MFurniBYGBlocksRegistry.sakura_drawer.get());
    		 event.accept(MFurniBYGBlocksRegistry.sakura_double_drawer.get());
    		 event.accept(MFurniBYGBlocksRegistry.sakura_bookshelf_drawer.get());
    		 event.accept(MFurniBYGBlocksRegistry.sakura_lower_bookshelf_drawer.get());
    		 event.accept(MFurniBYGBlocksRegistry.sakura_large_drawer.get());
    		 event.accept(MFurniBYGBlocksRegistry.sakura_lower_triple_drawer.get());
    		 event.accept(MFurniBYGBlocksRegistry.sakura_triple_drawer.get());
    		 event.accept(MFurniBYGBlocksRegistry.sakura_covered_desk.get());
    		 event.accept(MFurniBYGBlocksRegistry.sakura_modern_desk.get());
    		 event.accept(MFurniBYGBlocksRegistry.sakura_table.get());
    		 event.accept(MFurniBYGBlocksRegistry.sakura_end_table.get());
    		 event.accept(MFurniBYGBlocksRegistry.sakura_coffee_table.get());
    		 event.accept(MFurniBYGBlocksRegistry.sakura_glass_table.get());
    		 event.accept(MFurniBYGBlocksRegistry.sakura_chair.get());
    		 event.accept(MFurniBYGBlocksRegistry.sakura_modern_chair.get());
    		 event.accept(MFurniBYGBlocksRegistry.sakura_striped_chair.get());
    		 event.accept(MFurniBYGBlocksRegistry.sakura_stool_chair.get());
    		 event.accept(MFurniBYGBlocksRegistry.sakura_counter.get());
    		 event.accept(MFurniBYGBlocksRegistry.sakura_drawer_counter.get());
    		 event.accept(MFurniBYGBlocksRegistry.sakura_double_drawer_counter.get());
    		 event.accept(MFurniBYGBlocksRegistry.sakura_cupboard_counter.get());
    		 event.accept(MFurniBYGBlocksRegistry.stripped_sakura_wardrobe.get());
    		 event.accept(MFurniBYGBlocksRegistry.stripped_sakura_modern_wardrobe.get());
    		 event.accept(MFurniBYGBlocksRegistry.stripped_sakura_double_wardrobe.get());
    		 event.accept(MFurniBYGBlocksRegistry.stripped_sakura_bookshelf.get());
    		 event.accept(MFurniBYGBlocksRegistry.stripped_sakura_bookshelf_cupboard.get());
    		 event.accept(MFurniBYGBlocksRegistry.stripped_sakura_drawer.get());
    		 event.accept(MFurniBYGBlocksRegistry.stripped_sakura_double_drawer.get());
    		 event.accept(MFurniBYGBlocksRegistry.stripped_sakura_bookshelf_drawer.get());
    		 event.accept(MFurniBYGBlocksRegistry.stripped_sakura_lower_bookshelf_drawer.get());
    		 event.accept(MFurniBYGBlocksRegistry.stripped_sakura_large_drawer.get());
    		 event.accept(MFurniBYGBlocksRegistry.stripped_sakura_lower_triple_drawer.get());
    		 event.accept(MFurniBYGBlocksRegistry.stripped_sakura_triple_drawer.get());
    		 event.accept(MFurniBYGBlocksRegistry.stripped_sakura_desk.get());
    		 event.accept(MFurniBYGBlocksRegistry.stripped_sakura_covered_desk.get());
    		 event.accept(MFurniBYGBlocksRegistry.stripped_sakura_modern_desk.get());
    		 event.accept(MFurniBYGBlocksRegistry.stripped_sakura_table.get());
    		 event.accept(MFurniBYGBlocksRegistry.stripped_sakura_end_table.get());
    		 event.accept(MFurniBYGBlocksRegistry.stripped_sakura_coffee_table.get());
    		 event.accept(MFurniBYGBlocksRegistry.stripped_sakura_glass_table.get());
    		 event.accept(MFurniBYGBlocksRegistry.stripped_sakura_modern_chair.get());
    		 event.accept(MFurniBYGBlocksRegistry.stripped_sakura_striped_chair.get());
    		 event.accept(MFurniBYGBlocksRegistry.stripped_sakura_stool_chair.get());
    		 event.accept(MFurniBYGBlocksRegistry.stripped_sakura_counter.get());
    		 event.accept(MFurniBYGBlocksRegistry.stripped_sakura_drawer_counter.get());
    		 event.accept(MFurniBYGBlocksRegistry.stripped_sakura_double_drawer_counter.get());
    		 event.accept(MFurniBYGBlocksRegistry.stripped_sakura_cupboard_counter.get());
    		 event.accept(MFurniBYGBlocksRegistry.sakura_kitchen_cabinet.get());
    		 event.accept(MFurniBYGBlocksRegistry.sakura_double_kitchen_cabinet.get());
    		 event.accept(MFurniBYGBlocksRegistry.sakura_glass_kitchen_cabinet.get());
    		 event.accept(MFurniBYGBlocksRegistry.stripped_sakura_kitchen_cabinet.get());
    		 event.accept(MFurniBYGBlocksRegistry.stripped_sakura_double_kitchen_cabinet.get());
    		 event.accept(MFurniBYGBlocksRegistry.stripped_sakura_glass_kitchen_cabinet.get());
    		 ...
    		 event.accept(MFurniBYGBlocksRegistry.florus_wardrobe.get());
    		 event.accept(MFurniBYGBlocksRegistry.florus_modern_wardrobe.get());
    		 event.accept(MFurniBYGBlocksRegistry.florus_double_wardrobe.get());
    		 event.accept(MFurniBYGBlocksRegistry.florus_bookshelf.get());
    		 event.accept(MFurniBYGBlocksRegistry.florus_bookshelf_cupboard.get());
    		 event.accept(MFurniBYGBlocksRegistry.florus_drawer.get());
    		 event.accept(MFurniBYGBlocksRegistry.florus_double_drawer.get());
    		 event.accept(MFurniBYGBlocksRegistry.florus_bookshelf_drawer.get());
    		 event.accept(MFurniBYGBlocksRegistry.florus_lower_bookshelf_drawer.get());
    		 event.accept(MFurniBYGBlocksRegistry.florus_large_drawer.get());
    		 event.accept(MFurniBYGBlocksRegistry.florus_lower_triple_drawer.get());
    		 event.accept(MFurniBYGBlocksRegistry.florus_triple_drawer.get());
    		 event.accept(MFurniBYGBlocksRegistry.florus_covered_desk.get());
    		 event.accept(MFurniBYGBlocksRegistry.florus_modern_desk.get());
    		 event.accept(MFurniBYGBlocksRegistry.florus_table.get());
    		 event.accept(MFurniBYGBlocksRegistry.florus_end_table.get());
    		 event.accept(MFurniBYGBlocksRegistry.florus_coffee_table.get());
    		 event.accept(MFurniBYGBlocksRegistry.florus_glass_table.get());
    		 event.accept(MFurniBYGBlocksRegistry.florus_chair.get());
    		 event.accept(MFurniBYGBlocksRegistry.florus_modern_chair.get());
    		 event.accept(MFurniBYGBlocksRegistry.florus_striped_chair.get());
    		 event.accept(MFurniBYGBlocksRegistry.florus_stool_chair.get());
    		 event.accept(MFurniBYGBlocksRegistry.florus_counter.get());
    		 event.accept(MFurniBYGBlocksRegistry.florus_drawer_counter.get());
    		 event.accept(MFurniBYGBlocksRegistry.florus_double_drawer_counter.get());
    		 event.accept(MFurniBYGBlocksRegistry.florus_cupboard_counter.get());
    		 event.accept(MFurniBYGBlocksRegistry.stripped_florus_wardrobe.get());
    		 event.accept(MFurniBYGBlocksRegistry.stripped_florus_modern_wardrobe.get());
    		 event.accept(MFurniBYGBlocksRegistry.stripped_florus_double_wardrobe.get());
    		 event.accept(MFurniBYGBlocksRegistry.stripped_florus_bookshelf.get());
    		 event.accept(MFurniBYGBlocksRegistry.stripped_florus_bookshelf_cupboard.get());
    		 event.accept(MFurniBYGBlocksRegistry.stripped_florus_drawer.get());
    		 event.accept(MFurniBYGBlocksRegistry.stripped_florus_double_drawer.get());
    		 event.accept(MFurniBYGBlocksRegistry.stripped_florus_bookshelf_drawer.get());
    		 event.accept(MFurniBYGBlocksRegistry.stripped_florus_lower_bookshelf_drawer.get());
    		 event.accept(MFurniBYGBlocksRegistry.stripped_florus_large_drawer.get());
    		 event.accept(MFurniBYGBlocksRegistry.stripped_florus_lower_triple_drawer.get());
    		 event.accept(MFurniBYGBlocksRegistry.stripped_florus_triple_drawer.get());
    		 event.accept(MFurniBYGBlocksRegistry.stripped_florus_desk.get());
    		 event.accept(MFurniBYGBlocksRegistry.stripped_florus_covered_desk.get());
    		 event.accept(MFurniBYGBlocksRegistry.stripped_florus_modern_desk.get());
    		 event.accept(MFurniBYGBlocksRegistry.stripped_florus_table.get());
    		 event.accept(MFurniBYGBlocksRegistry.stripped_florus_end_table.get());
    		 event.accept(MFurniBYGBlocksRegistry.stripped_florus_coffee_table.get());
    		 event.accept(MFurniBYGBlocksRegistry.stripped_florus_glass_table.get());
    		 event.accept(MFurniBYGBlocksRegistry.stripped_florus_modern_chair.get());
    		 event.accept(MFurniBYGBlocksRegistry.stripped_florus_striped_chair.get());
    		 event.accept(MFurniBYGBlocksRegistry.stripped_florus_stool_chair.get());
    		 event.accept(MFurniBYGBlocksRegistry.stripped_florus_counter.get());
    		 event.accept(MFurniBYGBlocksRegistry.stripped_florus_drawer_counter.get());
    		 event.accept(MFurniBYGBlocksRegistry.stripped_florus_double_drawer_counter.get());
    		 event.accept(MFurniBYGBlocksRegistry.stripped_florus_cupboard_counter.get());
    		 event.accept(MFurniBYGBlocksRegistry.florus_kitchen_cabinet.get());
    		 event.accept(MFurniBYGBlocksRegistry.florus_double_kitchen_cabinet.get());
    		 event.accept(MFurniBYGBlocksRegistry.florus_glass_kitchen_cabinet.get());
    		 event.accept(MFurniBYGBlocksRegistry.stripped_florus_kitchen_cabinet.get());
    		 event.accept(MFurniBYGBlocksRegistry.stripped_florus_double_kitchen_cabinet.get());
    		 event.accept(MFurniBYGBlocksRegistry.stripped_florus_glass_kitchen_cabinet.get());
