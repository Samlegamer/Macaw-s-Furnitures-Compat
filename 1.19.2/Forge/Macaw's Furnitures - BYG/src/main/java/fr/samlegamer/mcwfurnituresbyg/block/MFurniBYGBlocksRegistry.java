...
public class MFurniBYGBlocksRegistry
{
	...
	public static final RegistryObject<Block> white_mangrove_wardrobe = createBlock("white_mangrove_wardrobe", () -> new TallFurnitureHinge(BlockBehaviour.Properties.of(Material.WOOD).strength(2.0F, 2.3F)));
	  
	  public static final RegistryObject<Block> white_mangrove_modern_wardrobe = createBlock("white_mangrove_modern_wardrobe", () -> new TallFurnitureHinge(BlockBehaviour.Properties.of(Material.WOOD).strength(2.0F, 2.3F)));
	  
	  public static final RegistryObject<Block> white_mangrove_double_wardrobe = createBlock("white_mangrove_double_wardrobe", () -> new TallFurniture(BlockBehaviour.Properties.of(Material.WOOD).strength(2.0F, 2.3F)));
	  
	  public static final RegistryObject<Block> white_mangrove_bookshelf = createBlock("white_mangrove_bookshelf", () -> new BookCabinet(BlockBehaviour.Properties.of(Material.WOOD).strength(2.0F, 2.3F)));
	  
	  public static final RegistryObject<Block> white_mangrove_bookshelf_cupboard = createBlock("white_mangrove_bookshelf_cupboard", () -> new BookCabinetHinge(BlockBehaviour.Properties.of(Material.WOOD).strength(2.0F, 2.3F)));
	  
	  public static final RegistryObject<Block> white_mangrove_drawer = createBlock("white_mangrove_drawer", () -> new WideFurniture(BlockBehaviour.Properties.of(Material.WOOD).strength(2.0F, 2.3F)));
	  
	  public static final RegistryObject<Block> white_mangrove_double_drawer = createBlock("white_mangrove_double_drawer", () -> new WideFurniture(BlockBehaviour.Properties.of(Material.WOOD).strength(2.0F, 2.3F)));
	  
	  public static final RegistryObject<Block> white_mangrove_bookshelf_drawer = createBlock("white_mangrove_bookshelf_drawer", () -> new BookDrawer(BlockBehaviour.Properties.of(Material.WOOD).strength(2.0F, 2.3F)));
	  
	  public static final RegistryObject<Block> white_mangrove_lower_bookshelf_drawer = createBlock("white_mangrove_lower_bookshelf_drawer", () -> new BookDrawer(BlockBehaviour.Properties.of(Material.WOOD).strength(2.0F, 2.3F)));
	  
	  public static final RegistryObject<Block> white_mangrove_large_drawer = createBlock("white_mangrove_large_drawer", () -> new WideFurniture(BlockBehaviour.Properties.of(Material.WOOD).strength(2.0F, 2.3F)));
	  
	  public static final RegistryObject<Block> white_mangrove_lower_triple_drawer = createBlock("white_mangrove_lower_triple_drawer", () -> new WideFurniture(BlockBehaviour.Properties.of(Material.WOOD).strength(2.0F, 2.3F)));
	  
	  public static final RegistryObject<Block> white_mangrove_triple_drawer = createBlock("white_mangrove_triple_drawer", () -> new WideFurniture(BlockBehaviour.Properties.of(Material.WOOD).strength(2.0F, 2.3F)));
	  
	  public static final RegistryObject<Block> white_mangrove_desk = createBlock("white_mangrove_desk", () -> new Desk(BlockBehaviour.Properties.of(Material.WOOD).strength(2.0F, 2.3F)));
	  
	  public static final RegistryObject<Block> white_mangrove_covered_desk = createBlock("white_mangrove_covered_desk", () -> new Desk(BlockBehaviour.Properties.of(Material.WOOD).strength(2.0F, 2.3F)));
	  
	  public static final RegistryObject<Block> white_mangrove_modern_desk = createBlock("white_mangrove_modern_desk", () -> new Desk(BlockBehaviour.Properties.of(Material.WOOD).strength(2.0F, 2.3F)));
	  
	  public static final RegistryObject<Block> white_mangrove_table = createBlock("white_mangrove_table", () -> new TableHitbox(BlockBehaviour.Properties.of(Material.WOOD).strength(2.0F, 2.3F)));
	  
	  public static final RegistryObject<Block> white_mangrove_end_table = createBlock("white_mangrove_end_table", () -> new TableHitbox(BlockBehaviour.Properties.of(Material.WOOD).strength(2.0F, 2.3F)));
	  
	  public static final RegistryObject<Block> white_mangrove_coffee_table = createBlock("white_mangrove_coffee_table", () -> new Table(BlockBehaviour.Properties.of(Material.WOOD).strength(2.0F, 2.3F)));
	  
	  public static final RegistryObject<Block> white_mangrove_glass_table = createBlock("white_mangrove_glass_table", () -> new TableHitbox(BlockBehaviour.Properties.of(Material.WOOD).strength(2.0F, 2.3F)));
	  
	  public static final RegistryObject<Block> white_mangrove_chair = createBlock("white_mangrove_chair", () -> new ClassicChair(BlockBehaviour.Properties.of(Material.WOOD).strength(2.0F, 2.3F)));
	  
	  public static final RegistryObject<Block> white_mangrove_modern_chair = createBlock("white_mangrove_modern_chair", () -> new ModernChair(BlockBehaviour.Properties.of(Material.WOOD).strength(2.0F, 2.3F)));
	  
	  public static final RegistryObject<Block> white_mangrove_striped_chair = createBlock("white_mangrove_striped_chair", () -> new StripedChair(BlockBehaviour.Properties.of(Material.WOOD).strength(2.0F, 2.3F)));
	  
	  public static final RegistryObject<Block> white_mangrove_stool_chair = createBlock("white_mangrove_stool_chair", () -> new Chair(BlockBehaviour.Properties.of(Material.WOOD).strength(2.0F, 2.3F)));
	  
	  public static final RegistryObject<Block> white_mangrove_counter = createBlock("white_mangrove_counter", () -> new Counter(BlockBehaviour.Properties.of(Material.WOOD).strength(2.0F, 2.3F)));
	  
	  public static final RegistryObject<Block> white_mangrove_drawer_counter = createBlock("white_mangrove_drawer_counter", () -> new StorageCounter(Blocks.OAK_LOG.defaultBlockState(), BlockBehaviour.Properties.of(Material.WOOD).strength(2.0F, 2.3F)));
	  
	  public static final RegistryObject<Block> white_mangrove_double_drawer_counter = createBlock("white_mangrove_double_drawer_counter", () -> new StorageCounter(Blocks.OAK_LOG.defaultBlockState(), BlockBehaviour.Properties.of(Material.WOOD).strength(2.0F, 2.3F)));
	  
	  public static final RegistryObject<Block> white_mangrove_cupboard_counter = createBlock("white_mangrove_cupboard_counter", () -> new CupboardCounter(BlockBehaviour.Properties.of(Material.WOOD).strength(2.0F, 2.3F)));
