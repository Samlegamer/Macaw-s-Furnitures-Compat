...
public class McwFurnituresBYG
{
	...
	private void ClientSetup(FMLClientSetupEvent event)
	{
		...
		ItemBlockRenderTypes.setRenderLayer((Block)MFurniBYGBlocksRegistry.mangrove_glass_table.get(), RenderType.translucent());
		ItemBlockRenderTypes.setRenderLayer((Block)MFurniBYGBlocksRegistry.stripped_mangrove_glass_table.get(), RenderType.translucent());
