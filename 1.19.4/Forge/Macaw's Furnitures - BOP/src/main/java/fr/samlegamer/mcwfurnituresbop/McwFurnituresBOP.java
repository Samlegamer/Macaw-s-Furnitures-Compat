...
public class McwFurnituresBOP
{
    ...
    {
        MFURNI_BOP = event.registerCreativeModeTab(new ResourceLocation("mcwfurnituresbop", "tab_mfurnibop"), builder -> builder
        .icon(() -> new ItemStack(MFurniBOPBlocksRegistry.cherry_bookshelf.get()))
        .title(Component.literal("Macaw's Furnitures - BOP")));
    }
    
    private void AddTab(CreativeModeTabEvent.BuildContents event)
    {
    	 if (event.getTab() == MFURNI_BOP)
    	 {
    		 event.accept(MFurniBOPBlocksRegistry.cherry_wardrobe.get());

    		 event.accept(MFurniBOPBlocksRegistry.cherry_modern_wardrobe.get());

    		 event.accept(MFurniBOPBlocksRegistry.cherry_double_wardrobe.get());

    		 event.accept(MFurniBOPBlocksRegistry.cherry_bookshelf.get());

    		 event.accept(MFurniBOPBlocksRegistry.cherry_bookshelf_cupboard.get());

    		 event.accept(MFurniBOPBlocksRegistry.cherry_drawer.get());

    		 event.accept(MFurniBOPBlocksRegistry.cherry_double_drawer.get());

    		 event.accept(MFurniBOPBlocksRegistry.cherry_bookshelf_drawer.get());

    		 event.accept(MFurniBOPBlocksRegistry.cherry_lower_bookshelf_drawer.get());

    		 event.accept(MFurniBOPBlocksRegistry.cherry_large_drawer.get());

    		 event.accept(MFurniBOPBlocksRegistry.cherry_lower_triple_drawer.get());

    		 event.accept(MFurniBOPBlocksRegistry.cherry_triple_drawer.get());

    		 event.accept(MFurniBOPBlocksRegistry.cherry_desk.get());

    		 event.accept(MFurniBOPBlocksRegistry.cherry_covered_desk.get());

    		 event.accept(MFurniBOPBlocksRegistry.cherry_modern_desk.get());

    		 event.accept(MFurniBOPBlocksRegistry.cherry_table.get());

    		 event.accept(MFurniBOPBlocksRegistry.cherry_end_table.get());

    		 event.accept(MFurniBOPBlocksRegistry.cherry_coffee_table.get());

    		 event.accept(MFurniBOPBlocksRegistry.cherry_glass_table.get());

    		 event.accept(MFurniBOPBlocksRegistry.cherry_chair.get());

    		 event.accept(MFurniBOPBlocksRegistry.cherry_modern_chair.get());

    		 event.accept(MFurniBOPBlocksRegistry.cherry_striped_chair.get());

    		 event.accept(MFurniBOPBlocksRegistry.cherry_stool_chair.get());

    		 event.accept(MFurniBOPBlocksRegistry.cherry_counter.get());

    		 event.accept(MFurniBOPBlocksRegistry.cherry_drawer_counter.get());

    		 event.accept(MFurniBOPBlocksRegistry.cherry_double_drawer_counter.get());

    		 event.accept(MFurniBOPBlocksRegistry.cherry_cupboard_counter.get());
