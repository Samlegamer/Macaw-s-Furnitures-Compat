...
public class MFurniBOPBlocksRegistry
{
	...
	public static final RegistryObject<Block> dead_wardrobe = createBlock("dead_wardrobe", () -> new TallFurnitureHinge(BlockBehaviour.Properties.of(Material.WOOD).strength(2.0F, 2.3F)));
	  
	  public static final RegistryObject<Block> dead_modern_wardrobe = createBlock("dead_modern_wardrobe", () -> new TallFurnitureHinge(BlockBehaviour.Properties.of(Material.WOOD).strength(2.0F, 2.3F)));
	  
	  public static final RegistryObject<Block> dead_double_wardrobe = createBlock("dead_double_wardrobe", () -> new TallFurniture(BlockBehaviour.Properties.of(Material.WOOD).strength(2.0F, 2.3F)));
	  
	  public static final RegistryObject<Block> dead_bookshelf = createBlock("dead_bookshelf", () -> new BookCabinet(BlockBehaviour.Properties.of(Material.WOOD).strength(2.0F, 2.3F)));
	  
	  public static final RegistryObject<Block> dead_bookshelf_cupboard = createBlock("dead_bookshelf_cupboard", () -> new BookCabinetHinge(BlockBehaviour.Properties.of(Material.WOOD).strength(2.0F, 2.3F)));
	  
	  public static final RegistryObject<Block> dead_drawer = createBlock("dead_drawer", () -> new WideFurniture(BlockBehaviour.Properties.of(Material.WOOD).strength(2.0F, 2.3F)));
	  
	  public static final RegistryObject<Block> dead_double_drawer = createBlock("dead_double_drawer", () -> new WideFurniture(BlockBehaviour.Properties.of(Material.WOOD).strength(2.0F, 2.3F)));
	  
	  public static final RegistryObject<Block> dead_bookshelf_drawer = createBlock("dead_bookshelf_drawer", () -> new BookDrawer(BlockBehaviour.Properties.of(Material.WOOD).strength(2.0F, 2.3F)));
	  
	  public static final RegistryObject<Block> dead_lower_bookshelf_drawer = createBlock("dead_lower_bookshelf_drawer", () -> new BookDrawer(BlockBehaviour.Properties.of(Material.WOOD).strength(2.0F, 2.3F)));
	  
	  public static final RegistryObject<Block> dead_large_drawer = createBlock("dead_large_drawer", () -> new WideFurniture(BlockBehaviour.Properties.of(Material.WOOD).strength(2.0F, 2.3F)));
	  
	  public static final RegistryObject<Block> dead_lower_triple_drawer = createBlock("dead_lower_triple_drawer", () -> new WideFurniture(BlockBehaviour.Properties.of(Material.WOOD).strength(2.0F, 2.3F)));
	  
	  public static final RegistryObject<Block> dead_triple_drawer = createBlock("dead_triple_drawer", () -> new WideFurniture(BlockBehaviour.Properties.of(Material.WOOD).strength(2.0F, 2.3F)));
	  
	  public static final RegistryObject<Block> dead_desk = createBlock("dead_desk", () -> new Desk(BlockBehaviour.Properties.of(Material.WOOD).strength(2.0F, 2.3F)));
	  
	  public static final RegistryObject<Block> dead_covered_desk = createBlock("dead_covered_desk", () -> new Desk(BlockBehaviour.Properties.of(Material.WOOD).strength(2.0F, 2.3F)));
	  
	  public static final RegistryObject<Block> dead_modern_desk = createBlock("dead_modern_desk", () -> new Desk(BlockBehaviour.Properties.of(Material.WOOD).strength(2.0F, 2.3F)));
	  
	  public static final RegistryObject<Block> dead_table = createBlock("dead_table", () -> new TableHitbox(BlockBehaviour.Properties.of(Material.WOOD).strength(2.0F, 2.3F)));
	  
	  public static final RegistryObject<Block> dead_end_table = createBlock("dead_end_table", () -> new TableHitbox(BlockBehaviour.Properties.of(Material.WOOD).strength(2.0F, 2.3F)));
	  
	  public static final RegistryObject<Block> dead_coffee_table = createBlock("dead_coffee_table", () -> new Table(BlockBehaviour.Properties.of(Material.WOOD).strength(2.0F, 2.3F)));
	  
	  public static final RegistryObject<Block> dead_glass_table = createBlock("dead_glass_table", () -> new TableHitbox(BlockBehaviour.Properties.of(Material.WOOD).strength(2.0F, 2.3F)));
	  
	  public static final RegistryObject<Block> dead_chair = createBlock("dead_chair", () -> new ClassicChair(BlockBehaviour.Properties.of(Material.WOOD).strength(2.0F, 2.3F)));
	  
	  public static final RegistryObject<Block> dead_modern_chair = createBlock("dead_modern_chair", () -> new ModernChair(BlockBehaviour.Properties.of(Material.WOOD).strength(2.0F, 2.3F)));
	  
	  public static final RegistryObject<Block> dead_striped_chair = createBlock("dead_striped_chair", () -> new StripedChair(BlockBehaviour.Properties.of(Material.WOOD).strength(2.0F, 2.3F)));
	  
	  public static final RegistryObject<Block> dead_stool_chair = createBlock("dead_stool_chair", () -> new Chair(BlockBehaviour.Properties.of(Material.WOOD).strength(2.0F, 2.3F)));
	  
	  public static final RegistryObject<Block> dead_counter = createBlock("dead_counter", () -> new Counter(BlockBehaviour.Properties.of(Material.WOOD).strength(2.0F, 2.3F)));
	  
	  public static final RegistryObject<Block> dead_drawer_counter = createBlock("dead_drawer_counter", () -> new StorageCounter(Blocks.OAK_LOG.defaultBlockState(), BlockBehaviour.Properties.of(Material.WOOD).strength(2.0F, 2.3F)));
	  
	  public static final RegistryObject<Block> dead_double_drawer_counter = createBlock("dead_double_drawer_counter", () -> new StorageCounter(Blocks.OAK_LOG.defaultBlockState(), BlockBehaviour.Properties.of(Material.WOOD).strength(2.0F, 2.3F)));
	  
	  public static final RegistryObject<Block> dead_cupboard_counter = createBlock("dead_cupboard_counter", () -> new CupboardCounter(BlockBehaviour.Properties.of(Material.WOOD).strength(2.0F, 2.3F)));
	...
	public static final RegistryObject<Block> hellbark_wardrobe = createBlock("hellbark_wardrobe", () -> new TallFurnitureHinge(BlockBehaviour.Properties.of(Material.WOOD).strength(2.0F, 2.3F)));
	  
	  public static final RegistryObject<Block> hellbark_modern_wardrobe = createBlock("hellbark_modern_wardrobe", () -> new TallFurnitureHinge(BlockBehaviour.Properties.of(Material.WOOD).strength(2.0F, 2.3F)));
	  
	  public static final RegistryObject<Block> hellbark_double_wardrobe = createBlock("hellbark_double_wardrobe", () -> new TallFurniture(BlockBehaviour.Properties.of(Material.WOOD).strength(2.0F, 2.3F)));
	  
	  public static final RegistryObject<Block> hellbark_bookshelf = createBlock("hellbark_bookshelf", () -> new BookCabinet(BlockBehaviour.Properties.of(Material.WOOD).strength(2.0F, 2.3F)));
	  
	  public static final RegistryObject<Block> hellbark_bookshelf_cupboard = createBlock("hellbark_bookshelf_cupboard", () -> new BookCabinetHinge(BlockBehaviour.Properties.of(Material.WOOD).strength(2.0F, 2.3F)));
	  
	  public static final RegistryObject<Block> hellbark_drawer = createBlock("hellbark_drawer", () -> new WideFurniture(BlockBehaviour.Properties.of(Material.WOOD).strength(2.0F, 2.3F)));
	  
	  public static final RegistryObject<Block> hellbark_double_drawer = createBlock("hellbark_double_drawer", () -> new WideFurniture(BlockBehaviour.Properties.of(Material.WOOD).strength(2.0F, 2.3F)));
	  
	  public static final RegistryObject<Block> hellbark_bookshelf_drawer = createBlock("hellbark_bookshelf_drawer", () -> new BookDrawer(BlockBehaviour.Properties.of(Material.WOOD).strength(2.0F, 2.3F)));
	  
	  public static final RegistryObject<Block> hellbark_lower_bookshelf_drawer = createBlock("hellbark_lower_bookshelf_drawer", () -> new BookDrawer(BlockBehaviour.Properties.of(Material.WOOD).strength(2.0F, 2.3F)));
	  
	  public static final RegistryObject<Block> hellbark_large_drawer = createBlock("hellbark_large_drawer", () -> new WideFurniture(BlockBehaviour.Properties.of(Material.WOOD).strength(2.0F, 2.3F)));
	  
	  public static final RegistryObject<Block> hellbark_lower_triple_drawer = createBlock("hellbark_lower_triple_drawer", () -> new WideFurniture(BlockBehaviour.Properties.of(Material.WOOD).strength(2.0F, 2.3F)));
	  
	  public static final RegistryObject<Block> hellbark_triple_drawer = createBlock("hellbark_triple_drawer", () -> new WideFurniture(BlockBehaviour.Properties.of(Material.WOOD).strength(2.0F, 2.3F)));
	  
	  public static final RegistryObject<Block> hellbark_desk = createBlock("hellbark_desk", () -> new Desk(BlockBehaviour.Properties.of(Material.WOOD).strength(2.0F, 2.3F)));
	  
	  public static final RegistryObject<Block> hellbark_covered_desk = createBlock("hellbark_covered_desk", () -> new Desk(BlockBehaviour.Properties.of(Material.WOOD).strength(2.0F, 2.3F)));
	  
	  public static final RegistryObject<Block> hellbark_modern_desk = createBlock("hellbark_modern_desk", () -> new Desk(BlockBehaviour.Properties.of(Material.WOOD).strength(2.0F, 2.3F)));
	  
	  public static final RegistryObject<Block> hellbark_table = createBlock("hellbark_table", () -> new TableHitbox(BlockBehaviour.Properties.of(Material.WOOD).strength(2.0F, 2.3F)));
	  
	  public static final RegistryObject<Block> hellbark_end_table = createBlock("hellbark_end_table", () -> new TableHitbox(BlockBehaviour.Properties.of(Material.WOOD).strength(2.0F, 2.3F)));
	  
	  public static final RegistryObject<Block> hellbark_coffee_table = createBlock("hellbark_coffee_table", () -> new Table(BlockBehaviour.Properties.of(Material.WOOD).strength(2.0F, 2.3F)));
	  
	  public static final RegistryObject<Block> hellbark_glass_table = createBlock("hellbark_glass_table", () -> new TableHitbox(BlockBehaviour.Properties.of(Material.WOOD).strength(2.0F, 2.3F)));
	  
	  public static final RegistryObject<Block> hellbark_chair = createBlock("hellbark_chair", () -> new ClassicChair(BlockBehaviour.Properties.of(Material.WOOD).strength(2.0F, 2.3F)));
	  
	  public static final RegistryObject<Block> hellbark_modern_chair = createBlock("hellbark_modern_chair", () -> new ModernChair(BlockBehaviour.Properties.of(Material.WOOD).strength(2.0F, 2.3F)));
	  
	  public static final RegistryObject<Block> hellbark_striped_chair = createBlock("hellbark_striped_chair", () -> new StripedChair(BlockBehaviour.Properties.of(Material.WOOD).strength(2.0F, 2.3F)));
	  
	  public static final RegistryObject<Block> hellbark_stool_chair = createBlock("hellbark_stool_chair", () -> new Chair(BlockBehaviour.Properties.of(Material.WOOD).strength(2.0F, 2.3F)));
	  
	  public static final RegistryObject<Block> hellbark_counter = createBlock("hellbark_counter", () -> new Counter(BlockBehaviour.Properties.of(Material.WOOD).strength(2.0F, 2.3F)));
	  
	  public static final RegistryObject<Block> hellbark_drawer_counter = createBlock("hellbark_drawer_counter", () -> new StorageCounter(Blocks.OAK_LOG.defaultBlockState(), BlockBehaviour.Properties.of(Material.WOOD).strength(2.0F, 2.3F)));
	  
	  public static final RegistryObject<Block> hellbark_double_drawer_counter = createBlock("hellbark_double_drawer_counter", () -> new StorageCounter(Blocks.OAK_LOG.defaultBlockState(), BlockBehaviour.Properties.of(Material.WOOD).strength(2.0F, 2.3F)));
	  
	  public static final RegistryObject<Block> hellbark_cupboard_counter = createBlock("hellbark_cupboard_counter", () -> new CupboardCounter(BlockBehaviour.Properties.of(Material.WOOD).strength(2.0F, 2.3F)));
	...
	public static final RegistryObject<Block> magic_wardrobe = createBlock("magic_wardrobe", () -> new TallFurnitureHinge(BlockBehaviour.Properties.of(Material.WOOD).strength(2.0F, 2.3F)));
	  
	  public static final RegistryObject<Block> magic_modern_wardrobe = createBlock("magic_modern_wardrobe", () -> new TallFurnitureHinge(BlockBehaviour.Properties.of(Material.WOOD).strength(2.0F, 2.3F)));
	  
	  public static final RegistryObject<Block> magic_double_wardrobe = createBlock("magic_double_wardrobe", () -> new TallFurniture(BlockBehaviour.Properties.of(Material.WOOD).strength(2.0F, 2.3F)));
	  
	  public static final RegistryObject<Block> magic_bookshelf = createBlock("magic_bookshelf", () -> new BookCabinet(BlockBehaviour.Properties.of(Material.WOOD).strength(2.0F, 2.3F)));
	  
	  public static final RegistryObject<Block> magic_bookshelf_cupboard = createBlock("magic_bookshelf_cupboard", () -> new BookCabinetHinge(BlockBehaviour.Properties.of(Material.WOOD).strength(2.0F, 2.3F)));
	  
	  public static final RegistryObject<Block> magic_drawer = createBlock("magic_drawer", () -> new WideFurniture(BlockBehaviour.Properties.of(Material.WOOD).strength(2.0F, 2.3F)));
	  
	  public static final RegistryObject<Block> magic_double_drawer = createBlock("magic_double_drawer", () -> new WideFurniture(BlockBehaviour.Properties.of(Material.WOOD).strength(2.0F, 2.3F)));
	  
	  public static final RegistryObject<Block> magic_bookshelf_drawer = createBlock("magic_bookshelf_drawer", () -> new BookDrawer(BlockBehaviour.Properties.of(Material.WOOD).strength(2.0F, 2.3F)));
	  
	  public static final RegistryObject<Block> magic_lower_bookshelf_drawer = createBlock("magic_lower_bookshelf_drawer", () -> new BookDrawer(BlockBehaviour.Properties.of(Material.WOOD).strength(2.0F, 2.3F)));
	  
	  public static final RegistryObject<Block> magic_large_drawer = createBlock("magic_large_drawer", () -> new WideFurniture(BlockBehaviour.Properties.of(Material.WOOD).strength(2.0F, 2.3F)));
	  
	  public static final RegistryObject<Block> magic_lower_triple_drawer = createBlock("magic_lower_triple_drawer", () -> new WideFurniture(BlockBehaviour.Properties.of(Material.WOOD).strength(2.0F, 2.3F)));
	  
	  public static final RegistryObject<Block> magic_triple_drawer = createBlock("magic_triple_drawer", () -> new WideFurniture(BlockBehaviour.Properties.of(Material.WOOD).strength(2.0F, 2.3F)));
	  
	  public static final RegistryObject<Block> magic_desk = createBlock("magic_desk", () -> new Desk(BlockBehaviour.Properties.of(Material.WOOD).strength(2.0F, 2.3F)));
	  
	  public static final RegistryObject<Block> magic_covered_desk = createBlock("magic_covered_desk", () -> new Desk(BlockBehaviour.Properties.of(Material.WOOD).strength(2.0F, 2.3F)));
	  
	  public static final RegistryObject<Block> magic_modern_desk = createBlock("magic_modern_desk", () -> new Desk(BlockBehaviour.Properties.of(Material.WOOD).strength(2.0F, 2.3F)));
	  
	  public static final RegistryObject<Block> magic_table = createBlock("magic_table", () -> new TableHitbox(BlockBehaviour.Properties.of(Material.WOOD).strength(2.0F, 2.3F)));
	  
	  public static final RegistryObject<Block> magic_end_table = createBlock("magic_end_table", () -> new TableHitbox(BlockBehaviour.Properties.of(Material.WOOD).strength(2.0F, 2.3F)));
	  
	  public static final RegistryObject<Block> magic_coffee_table = createBlock("magic_coffee_table", () -> new Table(BlockBehaviour.Properties.of(Material.WOOD).strength(2.0F, 2.3F)));
	  
	  public static final RegistryObject<Block> magic_glass_table = createBlock("magic_glass_table", () -> new TableHitbox(BlockBehaviour.Properties.of(Material.WOOD).strength(2.0F, 2.3F)));
	  
	  public static final RegistryObject<Block> magic_chair = createBlock("magic_chair", () -> new ClassicChair(BlockBehaviour.Properties.of(Material.WOOD).strength(2.0F, 2.3F)));
	  
	  public static final RegistryObject<Block> magic_modern_chair = createBlock("magic_modern_chair", () -> new ModernChair(BlockBehaviour.Properties.of(Material.WOOD).strength(2.0F, 2.3F)));
	  
	  public static final RegistryObject<Block> magic_striped_chair = createBlock("magic_striped_chair", () -> new StripedChair(BlockBehaviour.Properties.of(Material.WOOD).strength(2.0F, 2.3F)));
	  
	  public static final RegistryObject<Block> magic_stool_chair = createBlock("magic_stool_chair", () -> new Chair(BlockBehaviour.Properties.of(Material.WOOD).strength(2.0F, 2.3F)));
	  
	  public static final RegistryObject<Block> magic_counter = createBlock("magic_counter", () -> new Counter(BlockBehaviour.Properties.of(Material.WOOD).strength(2.0F, 2.3F)));
	  
	  public static final RegistryObject<Block> magic_drawer_counter = createBlock("magic_drawer_counter", () -> new StorageCounter(Blocks.OAK_LOG.defaultBlockState(), BlockBehaviour.Properties.of(Material.WOOD).strength(2.0F, 2.3F)));
	  
	  public static final RegistryObject<Block> magic_double_drawer_counter = createBlock("magic_double_drawer_counter", () -> new StorageCounter(Blocks.OAK_LOG.defaultBlockState(), BlockBehaviour.Properties.of(Material.WOOD).strength(2.0F, 2.3F)));
	  
	  public static final RegistryObject<Block> magic_cupboard_counter = createBlock("magic_cupboard_counter", () -> new CupboardCounter(BlockBehaviour.Properties.of(Material.WOOD).strength(2.0F, 2.3F)));
	...
	public static final RegistryObject<Block> umbran_wardrobe = createBlock("umbran_wardrobe", () -> new TallFurnitureHinge(BlockBehaviour.Properties.of(Material.WOOD).strength(2.0F, 2.3F)));
	  
	  public static final RegistryObject<Block> umbran_modern_wardrobe = createBlock("umbran_modern_wardrobe", () -> new TallFurnitureHinge(BlockBehaviour.Properties.of(Material.WOOD).strength(2.0F, 2.3F)));
	  
	  public static final RegistryObject<Block> umbran_double_wardrobe = createBlock("umbran_double_wardrobe", () -> new TallFurniture(BlockBehaviour.Properties.of(Material.WOOD).strength(2.0F, 2.3F)));
	  
	  public static final RegistryObject<Block> umbran_bookshelf = createBlock("umbran_bookshelf", () -> new BookCabinet(BlockBehaviour.Properties.of(Material.WOOD).strength(2.0F, 2.3F)));
	  
	  public static final RegistryObject<Block> umbran_bookshelf_cupboard = createBlock("umbran_bookshelf_cupboard", () -> new BookCabinetHinge(BlockBehaviour.Properties.of(Material.WOOD).strength(2.0F, 2.3F)));
	  
	  public static final RegistryObject<Block> umbran_drawer = createBlock("umbran_drawer", () -> new WideFurniture(BlockBehaviour.Properties.of(Material.WOOD).strength(2.0F, 2.3F)));
	  
	  public static final RegistryObject<Block> umbran_double_drawer = createBlock("umbran_double_drawer", () -> new WideFurniture(BlockBehaviour.Properties.of(Material.WOOD).strength(2.0F, 2.3F)));
	  
	  public static final RegistryObject<Block> umbran_bookshelf_drawer = createBlock("umbran_bookshelf_drawer", () -> new BookDrawer(BlockBehaviour.Properties.of(Material.WOOD).strength(2.0F, 2.3F)));
	  
	  public static final RegistryObject<Block> umbran_lower_bookshelf_drawer = createBlock("umbran_lower_bookshelf_drawer", () -> new BookDrawer(BlockBehaviour.Properties.of(Material.WOOD).strength(2.0F, 2.3F)));
	  
	  public static final RegistryObject<Block> umbran_large_drawer = createBlock("umbran_large_drawer", () -> new WideFurniture(BlockBehaviour.Properties.of(Material.WOOD).strength(2.0F, 2.3F)));
	  
	  public static final RegistryObject<Block> umbran_lower_triple_drawer = createBlock("umbran_lower_triple_drawer", () -> new WideFurniture(BlockBehaviour.Properties.of(Material.WOOD).strength(2.0F, 2.3F)));
	  
	  public static final RegistryObject<Block> umbran_triple_drawer = createBlock("umbran_triple_drawer", () -> new WideFurniture(BlockBehaviour.Properties.of(Material.WOOD).strength(2.0F, 2.3F)));
	  
	  public static final RegistryObject<Block> umbran_desk = createBlock("umbran_desk", () -> new Desk(BlockBehaviour.Properties.of(Material.WOOD).strength(2.0F, 2.3F)));
	  
	  public static final RegistryObject<Block> umbran_covered_desk = createBlock("umbran_covered_desk", () -> new Desk(BlockBehaviour.Properties.of(Material.WOOD).strength(2.0F, 2.3F)));
	  
	  public static final RegistryObject<Block> umbran_modern_desk = createBlock("umbran_modern_desk", () -> new Desk(BlockBehaviour.Properties.of(Material.WOOD).strength(2.0F, 2.3F)));
	  
	  public static final RegistryObject<Block> umbran_table = createBlock("umbran_table", () -> new TableHitbox(BlockBehaviour.Properties.of(Material.WOOD).strength(2.0F, 2.3F)));
	  
	  public static final RegistryObject<Block> umbran_end_table = createBlock("umbran_end_table", () -> new TableHitbox(BlockBehaviour.Properties.of(Material.WOOD).strength(2.0F, 2.3F)));
	  
	  public static final RegistryObject<Block> umbran_coffee_table = createBlock("umbran_coffee_table", () -> new Table(BlockBehaviour.Properties.of(Material.WOOD).strength(2.0F, 2.3F)));
	  
	  public static final RegistryObject<Block> umbran_glass_table = createBlock("umbran_glass_table", () -> new TableHitbox(BlockBehaviour.Properties.of(Material.WOOD).strength(2.0F, 2.3F)));
	  
	  public static final RegistryObject<Block> umbran_chair = createBlock("umbran_chair", () -> new ClassicChair(BlockBehaviour.Properties.of(Material.WOOD).strength(2.0F, 2.3F)));
	  
	  public static final RegistryObject<Block> umbran_modern_chair = createBlock("umbran_modern_chair", () -> new ModernChair(BlockBehaviour.Properties.of(Material.WOOD).strength(2.0F, 2.3F)));
	  
	  public static final RegistryObject<Block> umbran_striped_chair = createBlock("umbran_striped_chair", () -> new StripedChair(BlockBehaviour.Properties.of(Material.WOOD).strength(2.0F, 2.3F)));
	  
	  public static final RegistryObject<Block> umbran_stool_chair = createBlock("umbran_stool_chair", () -> new Chair(BlockBehaviour.Properties.of(Material.WOOD).strength(2.0F, 2.3F)));
	  
	  public static final RegistryObject<Block> umbran_counter = createBlock("umbran_counter", () -> new Counter(BlockBehaviour.Properties.of(Material.WOOD).strength(2.0F, 2.3F)));
	  
	  public static final RegistryObject<Block> umbran_drawer_counter = createBlock("umbran_drawer_counter", () -> new StorageCounter(Blocks.OAK_LOG.defaultBlockState(), BlockBehaviour.Properties.of(Material.WOOD).strength(2.0F, 2.3F)));
	  
	  public static final RegistryObject<Block> umbran_double_drawer_counter = createBlock("umbran_double_drawer_counter", () -> new StorageCounter(Blocks.OAK_LOG.defaultBlockState(), BlockBehaviour.Properties.of(Material.WOOD).strength(2.0F, 2.3F)));
	  
	  public static final RegistryObject<Block> umbran_cupboard_counter = createBlock("umbran_cupboard_counter", () -> new CupboardCounter(BlockBehaviour.Properties.of(Material.WOOD).strength(2.0F, 2.3F)));
	...
	public static final RegistryObject<Block> willow_wardrobe = createBlock("willow_wardrobe", () -> new TallFurnitureHinge(BlockBehaviour.Properties.of(Material.WOOD).strength(2.0F, 2.3F)));
	  ...
	  public static final RegistryObject<Block> willow_counter = createBlock("willow_counter", () -> new Counter(null, BlockBehaviour.Properties.of(Material.WOOD).strength(2.0F, 2.3F)));
